...
const GoogleIcon = () => (
    <svg className="w-5 h-5 mr-2 text-[#4285F4]" viewBox="0 0 24 24">
        <path
            d="M21.35 11.1H12v2.8h5.35a4.5 4.5 0 01-1.9 2.95l3.05 2.38C20.45 17.5 21.5 14.7 21.5 12c0-.6-.05-1.2-.15-1.8z"
            fill="#4285F4"
        />
        <path
            d="M12 22c2.4 0 4.4-.8 5.85-2.15l-3.05-2.38c-.8.55-1.85.85-2.8.85a5.1 5.1 0 01-4.8-3.5H3v2.2A9.94 9.94 0 0012 22z"
            fill="#34A853"
        />
        <path
            d="M7.2 13.8A5.2 5.2 0 016.9 12c0-.6.1-1.2.3-1.8V8h-3A10 10 0 002 12a10 10 0 005.2 8.8l2.8-2.2z"
            fill="#FBBC05"
        />
        <path
            d="M12 6.2c1.1 0 2.1.4 2.95 1.2l2.15-2.15A9.88 9.88 0 0012 2a10 10 0 00-9 6l3 2.2A5.1 5.1 0 0112 6.2z"
            fill="#EA4335"
        />
    </svg>
);
